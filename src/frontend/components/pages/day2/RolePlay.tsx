  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        <Timer duration={40 * 60} onTimeUp={handleNext} />
        <ProgressIndicator current={3} total={3} />
      </div>

      <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
        <h2 className="text-2xl font-bold mb-4">Role Play Section</h2>
        <p className="text-gray-600 mb-6">
          You will have 40 minutes to complete this section. You will be presented with a scenario and asked to role-play your response.
        </p>
